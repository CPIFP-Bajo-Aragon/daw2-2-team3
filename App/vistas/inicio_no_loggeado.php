...
<div class="container mt-3">
    ...
    <div class="col">
        <div class="container">
            ...
            <div class="card m-3">
                <div class="row g-0">
                    <div class="col-md-4 g-0">
                        <img src="img/media/casa.png" class="img-fluid rounded-start" alt="Card image">
                    </div>
                    <div class="col-md-8">
                        <div class="card-body">
            ...
            <div class="card m-3">
                <div class="row g-0">
                    <div class="col-md-2 g-0" style="background-image: url('img/media/casa.png'); background-size: cover; background-position: center">
                        <!-- <img src="img/casa.png" style="background-size:cover" class="img-fluid rounded-start" alt="Card image"> -->
                    </div>
                    <div class="col-md-8">
                        <div class="card-body">
                            <h5 class="card-title">Oferta en alcañiz</h5>
                    ...
                    <div class="col-md-2 g-0">
                        <div style="display: grid; grid-template-columns: 1fr; grid-template-rows: 1fr; align-items: center; justify-content: center; width: 100%; height: 100%;">
                            <img style="grid-column-start: 0; grid-column-end: 1; width: auto; height: 100%; opacity: 0.3; position:absolute;" src="img/media/casa.png" class="img-fluid" alt="Card image">
                            <img style="grid-column-start: 0; grid-column-end: 1; width: auto; height: 60%; position:absolute;" src="img/media/casa.png" class="img-fluid" alt="Card image">
                        </div>
                    </div>
